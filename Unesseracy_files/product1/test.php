...
$html->tag("div", 
	$html->gTag("div",
		...
		//id=navBar
		$html->gTag("div",
			$html->gBuildList(array(0=>"<a href='#'>Home</a>",
									1=>"<a href='products.php' class='nav'>Products</a>",
									2=>"<a href='register.php' class='nav'>Register</a>",
									3=>"<a href='checkout.php' class='nav'>Checkout</a>"),			
									"ul",	
...
$html->tag("div", //bodywrapper
	$html->gTag("div", //body
		$html->gTag("div", //leftcontent
			...
			$html->gTag("div", //all books
			
				/*This part will be downloaded dynamically*/
				$html->gTag("div", "<h2>NewBooks</h2>"  . listAllProducts() //all books
				,array("class"=>"all_books"))
