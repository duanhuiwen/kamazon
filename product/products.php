...
<div id="wrapper">
            ...
            <div id="main">
                ...
                <div id="content">
                	...
                	<a href="../frontpage/main.php">Home</a> > <a href="products.php">Books</a> 
                     ...
                     <div id="newBooks">
					 <!-- dynamic fetch the individual book, 3 books per column.--> 
						<?php
						echo listAllBooks($DBH);
						
						?>
					 <!--End dynamic fetch the individual book, 3 books per column. --> 
    ...
    <div id="footerWrapper">
        <div id="footer">
        	<p>&copy; 2012 Kamazon Online Bookstore</p>
        </div><!-- endFooter -->
