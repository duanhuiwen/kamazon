        ...
        <div id="body">
            ...
            <div id="main">
                ...
                <div id="content">
					...
					<!--dynamic fetch category name-->
					
					<!--CategoryId==0 is new books-->
					<!--CategoryId==1 is romance-->
					<!--CategoryId==2 is fiction-->
					<!--CategoryId==3 is fantasy-->
					<!--CategoryId==4 is coming soon (will not be listed in this page)-->
					<!--CategoryId==5 is horror-->
					<!--CategoryId==6 is teenager-->
					<?php
					...
					<!--end fetch category name-->
					
                    </div>
                    
                    <div id="singleItem">
						<ul>
						<!-- dynamic fetch single book one by one-->
							<?php
								fetchBookByCategory($DBH,$CategoryId);
							?>
